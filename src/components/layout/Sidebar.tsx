...
import { Home, Building2, CircleDollarSign, Users, MessageCircle, Bell, FileText, Settings, HelpCircle, Wallet } from 'lucide-react';

interface SidebarItemProps { to: string; icon: React.ReactNode; text: string; }
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        ...
        } ${text === "Dashboard" ? "tour-sidebar-dashboard" : ""} ${text === "Wallet" ? "tour-wallet" : ""}`
      }
    >
