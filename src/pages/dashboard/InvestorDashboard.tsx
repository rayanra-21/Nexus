...
export const InvestorDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Header */}
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 tour-investor-header">
        <div>
        ...
        <Link to="/entrepreneurs" className="tour-view-all-startups">
      ...
      {/* Filters + Search */}
      <div className="flex flex-col md:flex-row gap-4 tour-search-filter">
        ...
        <div className="w-full md:w-1/3">
          <div className="flex items-start space-x-2">
            <Filter size={18} className="text-gray-500 mt-1" />
            <div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
  ...
  <Card className="bg-accent-50 border border-accent-100">
    <CardBody>
      ...
      {/* Featured Startups */}
      <div className="tour-featured-startups">
        <Card>
          <CardHeader className="flex justify-between items-center">
            ...
            <span className="text-sm text-gray-500">
              Showing {filteredEntrepreneurs.length} results
            </span>
          </CardHeader>
